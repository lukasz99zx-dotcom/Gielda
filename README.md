...
- Pasek podsumowania przyklejony do dołu ekranu: suma wpływów ze sprzedaży minus
  suma wydatków na zakupy, na zielono gdy dodatnia, na czerwono gdy ujemna.
...
Gotowy plik APK: [`dist/cGielda-1.0.apk`](dist/cGielda-1.0.apk).
...
dostępu do `repo.maven.apache.org` oraz `github.com`.
...
app/
  ...
  src/pl/cgielda/app/
    ...
    Transaction.java        - model transakcji i logika wyliczania kwoty
    TransactionAdapter.java - renderowanie wiersza listy
build.sh                    - reprodukowalny skrypt budowania i podpisywania APK
dist/cGielda-1.0.apk        - gotowy do instalacji plik APK
```
